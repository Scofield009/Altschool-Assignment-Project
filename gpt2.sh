...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "slave" do |slave|
    ...
    slave.vm.network "private_network", type: "static", ip: "192.168.56.10"
    ...
    slave.vm.provision "shell", inline: <<-SHELL
      ...
      sudo -u altschool scp -o StrictHostKeyChecking=no /mnt/altschool/master_data.txt altschool@192.168.56.10:/mnt/altschool/slave/
  ...
  config.vm.define "loadbalancer" do |lb|
    ...
    lb.vm.network "private_network", type: "static", ip: "192.168.56.10"
